					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>客户级别 ：</td>
								<td>
									<select name="level.dict_id" id="levelID" style="WIDTH: 180px">
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select name="source.dict_id" id="sourcelID" style="WIDTH: 180px">
										<!-- <option value="">--请选择--</option> -->
									</select>
								</td>
								<td>联系人：</td>
							...
							<TR>
								...
								<td>上传资质：</td>
								<td>
									<INPUT type="file" class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="upload">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
