...
<script type="text/javascript">
	...
	// 可以阻止表单的提交		return false; 就阻止了表单的提交
	function checkForm(){
		// 先调用校验用户名的方法执行以下
		checkCode();
		// 获取error的数量，如果>0，表示存在错误，就不能提交表单		
		if($(".error").size() > 0)
			return false;
	}
</script>
...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/user_regist.action" onsubmit="return checkForm()" method=post target="_parent">
												...
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px">
																<INPUT id="user_password2" style="WIDTH: 130px" type=password name="user_password2">
															</TD>
															<TD style="HEIGHT: 28px">
																<SPAN id=RequiredFieldValidator5 style="FONT-WEIGHT: bold;"></SPAN>
															</TD>
														</TR>
														<TR>
															...
															<TD style="HEIGHT: 28px" width=370>
																<SPAN id=RequiredFieldValidator3 style="FONT-WEIGHT: bold;"></SPAN>
															</TD>
														</TR>
														<TR>
